export const BOOKS = [
  {
    id:'0',
    photo:'https://static.fnac-static.com/multimedia/Images/FR/NR/40/67/1e/1992512/1540-1/tsp20200411070916/Le-Seigneur-des-Anneaux.jpg',
    title:'Le Seigneur des Anneaux',
    author:'J.R.R. Tolkien',
    categorie:'Fantasy',
    date:'29/07/1954',
    extract:'Le monde est en vérité empli de périls, et il y a en lui maints lieux sombres ; mais il y en a encore beaucoup de beaux, et quoique dans tous les pays l\'amour se mêle maintenant d\'affliction, il n\'en devient peut-être que plus grand.'
  },
  {
    id:'1',
